...
export default function ProfileView() {
  ...
  // Sync form with fetched data — using useCallback to avoid stale deps warning
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 800 * 1024) {
      toast.error(t("profile.fileTooLarge", "File too large. Max 800 KB."));
      return;
    }
    setAvatarFile(file);
  ...
  const localisedCountryName = (c: {
    name: string;
    name_ar?: string;
    name_en?: string;
  }) => (isRtl ? c.name_ar || c.name : c.name_en || c.name);
  const localisedCityName = (c: {
    name: string;
    name_ar?: string;
    name_en?: string;
  }) => (isRtl ? c.name_ar || c.name : c.name_en || c.name);
        ...
        <TabsContent value="account">
          <div className="rounded-2xl border bg-card shadow-sm p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              {/* Country — AsyncPaginatedSelect: handles large lists with search */}
              <div className="space-y-1.5">
              ...
              {/* City — AsyncPaginatedSelect: filtered by selected country */}
              <div className="space-y-1.5">
                ...
                <AsyncPaginatedSelect
                  ...
                  placeholder={t("auth.register.selectCity", "Select city")}
          ...
          <TabsContent value="company">
            <div className="rounded-2xl border bg-card shadow-sm p-6 space-y-5">
              ...
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div className="space-y-1.5">
                  <Label>
                    {t("profile.companyNameEn", "Company Name (EN)")}
                  </Label>
                  <Input
                    value={clientNameEn}
                ...
                <div className="space-y-1.5">
                  <Label>
                    {t("profile.companyNameAr", "Company Name (AR)")}
                  </Label>
                  <Input
                    dir="rtl"
                    value={clientNameAr}
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border bg-muted/30 px-4 py-3 space-y-2">
                ...
                <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-3">
                  <PwReq
                    met={pwHas6}
                    label={t("profile.req6Chars")}
                  />
                  <PwReq
                    met={pwHasUp}
                    label={t("profile.req1Upper")}
                  />
                  <PwReq
                    met={pwHasNum}
                    label={t("profile.req1Number")}
                  />
                </div>
              </div>
