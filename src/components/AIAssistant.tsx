...
export function AIAssistant() {
  ...
  const waNumber = process.env.NEXT_PUBLIC_WA_NUMBER ?? "9665XXXXXXXX";
  const waUrl = `https://wa.me/${waNumber}?text=${encodeURIComponent(t("assistant.waGreeting"))}`;
  ...
  return (
    <>
      ...
      <Button
        ...
        size="icon"
        data-tour="assistant"
        className="fixed bottom-6 end-6 z-50 h-14 w-14 !rounded-full shadow-xl shadow-primary/40 ring-2 ring-primary/20 hover:shadow-primary/60 hover:scale-105 transition-all duration-200"
      ...
      <div
        dir={dir}
        className={cn(
          "fixed bottom-24 end-6 z-50 flex flex-col overflow-hidden rounded-2xl shadow-2xl transition-all duration-300",
